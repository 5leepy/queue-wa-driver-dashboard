...
export default function Home() {
  ...
  return (
    <div className="app-container">
      ...
      {/* GUIDE MODAL OVERLAY – Grup WhatsApp per POI */}
      {showGuide && (
        <div className="guide-overlay" onClick={() => { trackAction('close_help_guide', { method: 'overlay_click' }); setShowGuide(false); }}>
          <div className="guide-card" onClick={(e) => e.stopPropagation()}>
            <div className="guide-header">
              <h3 className="guide-title">💬 Grup WhatsApp Antrean</h3>
            ...
            <div className="guide-body">
              <p className="guide-subtitle-text">
                Bergabung ke grup WhatsApp antrean sesuai pangkalan Anda untuk menerima notifikasi dan update dari koordinator:
              </p>
              <div className="wa-links-list">
                {[
                  { code: 'PTC', name: 'Pakuwon Trade Center', label: 'Antrian_PTC',        url: 'https://chat.whatsapp.com/JVF1xUFVqFY3x3o7i6mLRI' },
                  { code: 'PCM', name: 'Pakuwon City Mall',    label: 'Antrian_PakuwonCity', url: 'https://chat.whatsapp.com/Ev6dydJ0hF3ETRKFJbPhsi' },
                  { code: 'RP',  name: 'Royal Plaza',          label: 'Antrian_RoyalPlaza',  url: 'https://chat.whatsapp.com/Hw1GUV8oYaW2vK00erKBOr' },
                  { code: 'TP',  name: 'Tunjungan Plaza',      label: 'Antrian_TP1',         url: 'https://chat.whatsapp.com/HuQUvYDLlEeL78SdKs8xMz' },
                ].map(({ code, name, label, url }) => (
                  <a
                    key={code}
                    href={url}
                    target="_blank"
                    ...
                    onClick={() => trackAction('click_wa_group', { poi_code: code, poi_name: name })}
                  >
                    <div className="wa-link-badge">{code}</div>
                    <div className="wa-link-info">
                      <span className="wa-link-name">{name}</span>
                      <span className="wa-link-label">{label}</span>
                    </div>
                    <div className="wa-link-arrow">
